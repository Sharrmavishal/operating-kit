...
`BOOTSTRAP-PROMPT.md`. It will: copy `operating-principles.md` in, write the seed
memories into that project's memory dir, explore the codebase, and draft a
project-specific `CLAUDE.md` from the template — then ask you to confirm the specifics.
