...
tool-neutral — it works in any assistant. The **packaging** (auto-loading, subagents, memory)
...
## Install
Use `BOOTSTRAP-CURSOR.md` (paste into the Cursor Agent — it self-clones and installs), or do it
