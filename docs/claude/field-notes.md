...
work; these are the specific **traps** — each one silently shipped a wrong result on a real
...
**Why it's silent:** schema diffs make the table *look* migrated. No error — the data step was
