...
- **Distribution:** a mean/average hides skew. A "7.5 average" can be a handful of giants
  dragging up a long thin tail. Look at the histogram/percentiles, not the average.
